...
<div class="container mx-auto p-6 bg-gradient-to-r from-blue-500 to-teal-500 rounded-lg shadow-lg">
    ...
    <div class="flex justify-center space-x-4 mb-4">
        ...
        <a href="{{ route('users.export') }}" class="bg-blue-500  hover:bg-green-600 text-white py-2 px-4 rounded-md flex items-center space-x-2">
        ...
        <a href="{{ route('users.import.view') }}" class="bg-blue-500  hover:bg-green-600 text-white py-2 px-4 rounded-md flex items-center space-x-2">
            <svg fill="#000000" width="20px" height="20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
